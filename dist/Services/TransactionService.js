...
var TransactionService = /** @class */ (function () {
    ...
    TransactionService.prototype.addTransaction = function (FromAccount, ToAccount, Amount, Status) {
        return __awaiter(this, void 0, void 0, function () {
            var transaction, transactionId;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        transaction = new Transaction_Model_1.Transaction(FromAccount, ToAccount, Amount, Status);
                        return [4 /*yield*/, transactionRepo.insert(transaction)];
                    case 1:
                        transactionId = (_a.sent()).toString() || "";
